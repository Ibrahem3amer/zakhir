...
@section('content')
	<div class="page_content">
	    ...
	    @elseif( empty(session('error')) )
	    	<div role="alert" class="alert alert-success"> <strong>تم تعديل البيانات!</strong></div>
    	@else
	    ...
	    <div class="form">
	        <form class="form-horizontal" action="{{ URL::to('/') }}/admin/edituser" method="post">
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <input type="text" value="{{ $user->name }}" name="user_name" class="form-control" id="input0" placeholder="اسم العضو">
	                </div>
	            </div>
				<div class="form-group">
	                <label for="input1" class="col-sm-2 control-label bring_right left_text">الإيميل</label>
	                <div class="col-sm-10">
	                    <input type="text" value="{{ $user->email }}" name="user_mail" class="form-control" id="input1" placeholder="الإيميل" disabled>
	                </div>
	            </div>
				<div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    ...
	                    <small>اترك الحقل فارغ لتبقى كلمة السر كما هي</small>
	                </div>
	            </div>
				<div class="form-group">
	                <label for="input3" class="col-sm-2 control-label bring_right left_text">عنوان الشحن والتوصيل</label>
	                <div class="col-sm-10">
	                    <textarea name="user_address" class="form-control" id="input3">{{$user->address}}</textarea>
	                </div>
	            </div>
	            <div class="form-group">
